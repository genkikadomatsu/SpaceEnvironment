...
{
    public class DictationSynthesis : MonoBehaviour
    {
        /// <summary>
        ...
        public static DictationSynthesis instance;
        #endregion
        ...
        private void Speak()
        {
            ...
            myTextbox.text = _mSpeakText;
        }


    public void MySpeak(string speaking, int voiceIndex = 0)
    {
            ...
            _mSpeechSynthesisPlugin.SetText(_mSpeechSynthesisUtterance, speaking);

            // Wait for speaking to end before doing detection
            _mWaitForOnEnd = true;

            _mSpeechSynthesisPlugin.SetVolume(_mSpeechSynthesisUtterance, _mVolume);
            _mSpeechSynthesisPlugin.SetVoice(_mSpeechSynthesisUtterance, _mVoiceResult.voices[voiceIndex]);
